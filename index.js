...
var ASM_CONSTS = {
  13399536: () => { if (document.fullscreenElement) return 1; },  
 13399582: () => { return document.getElementById('canvas').width; },  
 13399634: () => { return parseInt(document.getElementById('canvas').style.width); },  
 13399702: () => { document.exitFullscreen(); },  
 13399729: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 13399802: () => { if (document.fullscreenElement) return 1; },  
 13399848: () => { return document.getElementById('canvas').width; },  
 13399900: () => { return screen.width; },  
 13399925: () => { document.exitFullscreen(); },  
 13399952: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 13400085: () => { return window.innerWidth; },  
 13400111: () => { return window.innerHeight; },  
 13400138: () => { if (document.fullscreenElement) return 1; },  
 13400184: () => { return document.getElementById('canvas').width; },  
 13400236: () => { return parseInt(document.getElementById('canvas').style.width); },  
 13400304: () => { if (document.fullscreenElement) return 1; },  
 13400350: () => { return document.getElementById('canvas').width; },  
 13400402: () => { return screen.width; },  
 13400427: () => { return window.innerWidth; },  
 13400453: () => { return window.innerHeight; },  
 13400480: () => { if (document.fullscreenElement) return 1; },  
 13400526: () => { return document.getElementById('canvas').width; },  
 13400578: () => { return screen.width; },  
 13400603: () => { document.exitFullscreen(); },  
 13400630: () => { if (document.fullscreenElement) return 1; },  
 13400676: () => { return document.getElementById('canvas').width; },  
 13400728: () => { return parseInt(document.getElementById('canvas').style.width); },  
 13400796: () => { document.exitFullscreen(); },  
 13400823: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 13400881: () => { return screen.width; },  
 13400906: () => { return screen.height; },  
 13400932: () => { return window.screenX; },  
 13400959: () => { return window.screenY; },  
 13400986: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 13401039: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 13401110: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 13401167: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 13401423: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 13401494: () => { if (document.fullscreenElement) return 1; },  
 13401540: () => { return window.innerWidth; },  
 13401566: () => { return window.innerHeight; },  
 13401593: () => { if (document.pointerLockElement) return 1; }
};
