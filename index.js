...
var ASM_CONSTS = {
  445200: () => { if (document.fullscreenElement) return 1; },  
 445246: () => { return Module.canvas.width; },  
 445278: () => { return parseInt(Module.canvas.style.width); },  
 445326: () => { document.exitFullscreen(); },  
 445353: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 445426: () => { if (document.fullscreenElement) return 1; },  
 445472: () => { return Module.canvas.width; },  
 445504: () => { return screen.width; },  
 445529: () => { document.exitFullscreen(); },  
 445556: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 445689: () => { return window.innerWidth; },  
 445715: () => { return window.innerHeight; },  
 445742: () => { if (document.fullscreenElement) return 1; },  
 445788: () => { return Module.canvas.width; },  
 445820: () => { return parseInt(Module.canvas.style.width); },  
 445868: () => { if (document.fullscreenElement) return 1; },  
 445914: () => { return Module.canvas.width; },  
 445946: () => { return screen.width; },  
 445971: () => { return window.innerWidth; },  
 445997: () => { return window.innerHeight; },  
 446024: () => { if (document.fullscreenElement) return 1; },  
 446070: () => { return Module.canvas.width; },  
 446102: () => { return screen.width; },  
 446127: () => { document.exitFullscreen(); },  
 446154: () => { if (document.fullscreenElement) return 1; },  
 446200: () => { return Module.canvas.width; },  
 446232: () => { return parseInt(Module.canvas.style.width); },  
 446280: () => { document.exitFullscreen(); },  
 446307: ($0) => { Module.canvas.style.opacity = $0; },  
 446345: () => { return screen.width; },  
 446370: () => { return screen.height; },  
 446396: () => { return window.screenX; },  
 446423: () => { return window.screenY; },  
 446450: () => { return window.devicePixelRatio; },  
 446486: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 446539: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 446590: () => { Module.canvas.style.cursor = 'none'; },  
 446627: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 446883: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 446934: () => { if (document.fullscreenElement) return 1; },  
 446980: () => { return window.innerWidth; },  
 447006: () => { return window.innerHeight; },  
 447033: () => { if (document.pointerLockElement) return 1; }
};
