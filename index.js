...
var ASM_CONSTS = {
  13439056: () => { if (document.fullscreenElement) return 1; },  
 13439102: () => { return document.getElementById('canvas').width; },  
 13439154: () => { return parseInt(document.getElementById('canvas').style.width); },  
 13439222: () => { document.exitFullscreen(); },  
 13439249: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 13439322: () => { if (document.fullscreenElement) return 1; },  
 13439368: () => { return document.getElementById('canvas').width; },  
 13439420: () => { return screen.width; },  
 13439445: () => { document.exitFullscreen(); },  
 13439472: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 13439605: () => { return window.innerWidth; },  
 13439631: () => { return window.innerHeight; },  
 13439658: () => { if (document.fullscreenElement) return 1; },  
 13439704: () => { return document.getElementById('canvas').width; },  
 13439756: () => { return parseInt(document.getElementById('canvas').style.width); },  
 13439824: () => { if (document.fullscreenElement) return 1; },  
 13439870: () => { return document.getElementById('canvas').width; },  
 13439922: () => { return screen.width; },  
 13439947: () => { return window.innerWidth; },  
 13439973: () => { return window.innerHeight; },  
 13440000: () => { if (document.fullscreenElement) return 1; },  
 13440046: () => { return document.getElementById('canvas').width; },  
 13440098: () => { return screen.width; },  
 13440123: () => { document.exitFullscreen(); },  
 13440150: () => { if (document.fullscreenElement) return 1; },  
 13440196: () => { return document.getElementById('canvas').width; },  
 13440248: () => { return parseInt(document.getElementById('canvas').style.width); },  
 13440316: () => { document.exitFullscreen(); },  
 13440343: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 13440401: () => { return screen.width; },  
 13440426: () => { return screen.height; },  
 13440452: () => { return window.screenX; },  
 13440479: () => { return window.screenY; },  
 13440506: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 13440559: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 13440630: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 13440687: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 13440943: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 13441014: () => { if (document.fullscreenElement) return 1; },  
 13441060: () => { return window.innerWidth; },  
 13441086: () => { return window.innerHeight; },  
 13441113: () => { if (document.pointerLockElement) return 1; }
};
