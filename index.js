...
var ASM_CONSTS = {
  13399712: () => { if (document.fullscreenElement) return 1; },  
 13399758: () => { return document.getElementById('canvas').width; },  
 13399810: () => { return parseInt(document.getElementById('canvas').style.width); },  
 13399878: () => { document.exitFullscreen(); },  
 13399905: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 13399978: () => { if (document.fullscreenElement) return 1; },  
 13400024: () => { return document.getElementById('canvas').width; },  
 13400076: () => { return screen.width; },  
 13400101: () => { document.exitFullscreen(); },  
 13400128: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 13400261: () => { return window.innerWidth; },  
 13400287: () => { return window.innerHeight; },  
 13400314: () => { if (document.fullscreenElement) return 1; },  
 13400360: () => { return document.getElementById('canvas').width; },  
 13400412: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 13400603: () => { return window.innerWidth; },  
 13400629: () => { return window.innerHeight; },  
 13400656: () => { if (document.fullscreenElement) return 1; },  
 13400702: () => { return document.getElementById('canvas').width; },  
 13400754: () => { return screen.width; },  
 13400779: () => { document.exitFullscreen(); },  
 13400806: () => { if (document.fullscreenElement) return 1; },  
 13400852: () => { return document.getElementById('canvas').width; },  
 13400904: () => { return parseInt(document.getElementById('canvas').style.width); },  
 13400972: () => { document.exitFullscreen(); },  
 13400999: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 13401057: () => { return screen.width; },  
 13401082: () => { return screen.height; },  
 13401108: () => { return window.screenX; },  
 13401135: () => { return window.screenY; },  
 13401162: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 13401215: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 13401286: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 13401343: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 13401599: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 13401670: () => { if (document.fullscreenElement) return 1; },  
 13401716: () => { return window.innerWidth; },  
 13401742: () => { return window.innerHeight; },  
 13401769: () => { if (document.pointerLockElement) return 1; }
};
