...
var ASM_CONSTS = {
  13399872: () => { if (document.fullscreenElement) return 1; },  
 13399918: () => { return document.getElementById('canvas').width; },  
 13399970: () => { return parseInt(document.getElementById('canvas').style.width); },  
 13400038: () => { document.exitFullscreen(); },  
 13400065: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 13400138: () => { if (document.fullscreenElement) return 1; },  
 13400184: () => { return document.getElementById('canvas').width; },  
 13400236: () => { return screen.width; },  
 13400261: () => { document.exitFullscreen(); },  
 13400288: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 13400421: () => { return window.innerWidth; },  
 13400447: () => { return window.innerHeight; },  
 13400474: () => { if (document.fullscreenElement) return 1; },  
 13400520: () => { return document.getElementById('canvas').width; },  
 13400572: () => { return parseInt(document.getElementById('canvas').style.width); },  
 13400640: () => { if (document.fullscreenElement) return 1; },  
 13400686: () => { return document.getElementById('canvas').width; },  
 13400738: () => { return screen.width; },  
 13400763: () => { return window.innerWidth; },  
 13400789: () => { return window.innerHeight; },  
 13400816: () => { if (document.fullscreenElement) return 1; },  
 13400862: () => { return document.getElementById('canvas').width; },  
 13400914: () => { return screen.width; },  
 13400939: () => { document.exitFullscreen(); },  
 13400966: () => { if (document.fullscreenElement) return 1; },  
 13401012: () => { return document.getElementById('canvas').width; },  
 13401064: () => { return parseInt(document.getElementById('canvas').style.width); },  
 13401132: () => { document.exitFullscreen(); },  
 13401159: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 13401217: () => { return screen.width; },  
 13401242: () => { return screen.height; },  
 13401268: () => { return window.screenX; },  
 13401295: () => { return window.screenY; },  
 13401322: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 13401375: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 13401446: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 13401503: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 13401759: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 13401830: () => { if (document.fullscreenElement) return 1; },  
 13401876: () => { return window.innerWidth; },  
 13401902: () => { return window.innerHeight; },  
 13401929: () => { if (document.pointerLockElement) return 1; }
};
